...
T
;; Interactions below would now have the HTTP/1.1 header that we've added
;; to make this request handler work with modern browsers
...
These two chapters both focused on adding functionality to Dice of Doom.  They
didn't really introduce any big new ideas.  To see how Dice of Doom changed,
refer to dice_of_doom_v3.lisp for web features and dice_of_doom_v4.lisp for
more players and actual dice rolling.  It was pretty cool to see how little
we had to modify things to introduce these new features.
